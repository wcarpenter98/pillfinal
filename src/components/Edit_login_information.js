    ...
    <div class="container-fluid text-center mt-5">
        <div class="container-fluid text-center mt-5">
            ...
            <form id="login-form" class="justify-content-center">
                <div class="row">
                    <h1 class="display-6">Edit Login Information</h1>
                </div>
                <div class="row justify-content-center my-2">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5 col-6">
                        <input id="login-username" type="text" class="form-control" placeholder="Enter New Username" autofocus required/>
                    </div>
                </div>
                <div class="row justify-content-center my-2">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5 col-6">
                        <input id="login-password" type="password" class="form-control" placeholder="Enter New Password" required/>
                    </div>
                </div>
                <div class="row justify-content-center my-2">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5 col-6">
...
export default Edit_login_information;